...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { address: @trainer.address, current_weight: @trainer.current_weight, email_address: @trainer.email_address, height: @trainer.height, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { address: @trainer.address, current_weight: @trainer.current_weight, email_address: @trainer.email_address, height: @trainer.height, name: @trainer.name } }
